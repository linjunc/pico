...
final class PicoAppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func makeBrandIcon(size: CGFloat) -> NSImage {
        ...
        left.move(to: NSPoint(x: size * 43 / 150, y: size * 34 / 150))
        left.line(to: NSPoint(x: size * 43 / 150, y: size * 115 / 150))
        left.line(to: NSPoint(x: size * 79 / 150, y: size * 115 / 150))
        ...
        right.curve(to: NSPoint(x: size * 140 / 150, y: size * 64 / 150), controlPoint1: NSPoint(x: size * 131 / 150, y: size * 85 / 150), controlPoint2: NSPoint(x: size * 140 / 150, y: size * 76 / 150))
        right.curve(to: NSPoint(x: size * 118 / 150, y: size * 43 / 150), controlPoint1: NSPoint(x: size * 140 / 150, y: size * 52 / 150), controlPoint2: NSPoint(x: size * 131 / 150, y: size * 43 / 150))
        right.line(to: NSPoint(x: size * 84 / 150, y: size * 43 / 150))
